...
const loadDetails = (data, imgSerial) => {
  ...
  prevBTN.innerHTML = `<img src="https://cdn-icons-png.flaticon.com/512/892/892512.png" width='80' class="position-absolute start-0 top-50 bottom-50 m-auto pointer" alt="..." onclick="onPrev('${imgSerial}')" />`;
