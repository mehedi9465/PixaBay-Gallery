...
const loadDetails = (data, imgSerial) => {
  ...
  nextBTN.innerHTML = `<button class="btn btn-secondary border-0 outline-n">Next</button>`
  ...
  prevBTN.innerHTML = `<button class="btn btn-secondary border-0 outline-n">Prev</button>`
