...
const loadDetails = (data, imgSerial) => {
  ...
  nextBTN.innerHTML = `<img src="https://cdn-icons-png.flaticon.com/512/892/892528.png" class="position-absolute end-0 top-50 bottom-50 m-auto cursor-pointer" alt="..." onclick="onNext('${imgSerial}')">`;
