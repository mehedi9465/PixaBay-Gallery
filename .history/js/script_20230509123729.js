...
const loadDetails = (data, imgSerial) => {
  ...
  nextBTN.innerHTML = `<button class="btn btn-secondary border-0 outline">Next</button>`
  ...
  prevBTN.innerHTML = `<button class="btn btn-secondary border-0 outline">Prev</button>`
