...
const loadDetails = (data, imgSerial) => {
  ...
  const nextBTN.innerHTML = `<button class="btn btn-secondary border-0 outline-0">Next</button>`
  // nextBTN.innerHTML = `<img src="https://cdn-icons-png.flaticon.com/512/892/892512.png" class="position-absolute start-0 top-50 bottom-50 m-auto cursor-pointer" alt="..." onclick="onNext('${imgSerial}')" />`;
  
  const prevBTN.innerHTML = `<button class="btn btn-secondary border-0 outline-0">Prev</button>`
  // prevBTN.innerHTML = `<img src="https://cdn-icons-png.flaticon.com/512/892/892528.png" class="position-absolute end-0 top-50 bottom-50 m-auto cursor-pointer" alt="..." onclick="onPrev('${imgSerial}')" />`;
